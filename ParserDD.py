...
try:
        ...
        DBMRDPASSWD = os.popen("cat "+PodPasswdProp+"|grep -w daas_daasdb_user_password|awk -F= '{print $2}'").read()
        ...
        DBHOSTNAME = os.popen('hostname').read()
...
dict['DD_IPLIST_INTRA'] = '0.0.0.0'
dict['DD_IPLIST_PUBLIC'] = '0.0.0.0'
