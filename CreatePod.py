...
if os.path.isdir(auto_work+'/pyconf') is True and  os.path.isdir(auto_work+'/daas-ops-home/daas-ops/chef/generator-gen2/output') is True  and os.path.isfile(auto_work+'/pod.json') is True and os.path.isfile(auto_work+'/daasidm.json') is True and os.path.isfile(auto_work+'/override-key.key') is True:
        ...
        try:
                ...
                doScp(MvmUser,MvmPasswd,MvmName,NpgOutputDir,auto_work+'/daas-ops-home/daas-ops/chef/generator-gen2/output/*')
