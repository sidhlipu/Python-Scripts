...
mw_home="/u01/work/app/install_odi/Oracle";
...
wls_domain_name="odistandaloneagent";
...
service_db_url='jdbc:oracle:thin:@localhost:1521/orcl.us.oracle.com';
